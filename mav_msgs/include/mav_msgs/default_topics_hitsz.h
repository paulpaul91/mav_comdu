...
static constexpr char COMMAND_IMAGE_ARM_TRAJECTORY[] = "command/Image_arm_trajectory";

static constexpr char ROI[] = "roi";
static constexpr char QUADROTOR_ODOMETRY[] = "odometry_sensor1/odometry";
static constexpr char GRIPPER_ODOMETRY[] = "odometry_sensor2/odometry";
